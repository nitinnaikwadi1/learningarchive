...
import 'package:learningarchive/flashcards/vachan_card_slide_widget.dart';
import 'package:learningarchive/theme/circle_action_button_widget.dart';

class VachanDataCardWidget extends StatefulWidget {
  final String whichContent;
  final String whichAudio;
  const VachanDataCardWidget(
      {Key? key, required this.whichContent, required this.whichAudio})
      : super(key: key);

  @override
  State<VachanDataCardWidget> createState() => _VachanDataCardWidgetState();
}

class _VachanDataCardWidgetState extends State<VachanDataCardWidget>
  ...
  tempFilterAudio() {
    if (widget.whichContent == 'vakya.json') {
      setState(() {
